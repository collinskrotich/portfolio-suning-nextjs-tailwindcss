  ...
  return (
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <Image className='absolute z-1' layout='fill' objectFit='cover' src={temptagproj} alt='/' />
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                <h2 className='py-2'>  Temperature Tag IOT Solution </h2>
                <h3>IOT/React JS/ Tailwind/ AWS</h3>
            </div>
        </div>
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                <h2>Overview</h2>
                <p>
                    A temperature tag IOT application that collects temperature, humidity & acceleration endpoints hosted on AWS.
                </p>
                <a href='https://iot-temperature-tag.vercel.app' target="_blank" rel="noopener noreferrer">
                <button className='px-8 py-2 mt-4 mr-8'>Live Link</button>
                </a>
                <a href='https://github.com/collinskrotich/iot_temperature_tag' target="_blank" rel="noopener noreferrer">
