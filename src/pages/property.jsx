...
import propertyImg from '../../public/to-do-list.png';
    ...
    <div className='w-full'>
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                <h2>Overview</h2>
                <p>
                    A serverless to-do list application using React and Typescript hosted on AWS.
                </p>
            ...
            <div className='grid grid-cols-3 md:grid-cols-1'>
                <p className='text-gray-600 py-2 flex items-center'><RiRadioButtonFill className='pr-1'/>Serverless</p>
