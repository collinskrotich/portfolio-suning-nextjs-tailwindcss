    ...
    <div className='w-full md:h-screen p-2 flex items-center py-16'>
        <div className='max-w[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <p>
                    Having spent 3 years in the telecom industry working for network operators and vendors, I always had a knack for technology and computers.
                ...
                <p className='py-4'>
                    I quickly developed a passion for programming and yeared to learn more. 
                    I continued building projects consistently and improving the earlier projects I had built. 
                    At my company I transioned from being a support IoT engineer to a software engineer focussing on building scalable IoT web applications.
                </p>
                <p className='py-4'>
                    I am now spending my time learning serverless and building event-driven software applications on cloud(AWS, GCP, Azure).
                    </p>
                    <p className='py-2 underline cursor-pointer'>Check out some of my latest projects.
                </p>
            </div>
